...
def generate_launch_description():
    ...
    wheeltec_robot_dir = get_package_share_directory('robot_controller')
    ...
    my_map_file = '/home/robot/Robot/install/wheeltec_nav2/share/wheeltec_nav2/map/WHEELTEC.yaml'
    ...
    wheeltec_robot = IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(wheeltec_launch_dir, 'ASR_robot_nav.launch.py')),
    )
